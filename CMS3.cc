...
void CMS3::Init(TTree *tree) {
  ...
  pfjets_matched_branch = 0;
  if (tree->GetAlias("pfjets_matched") != 0) {
    pfjets_matched_branch = tree->GetBranch(tree->GetAlias("pfjets_matched"));
    if (pfjets_matched_branch) { pfjets_matched_branch->SetAddress(&pfjets_matched_); }
  }
  ...
  pfjets_type_branch = 0;
  if (tree->GetAlias("pfjets_type") != 0) {
    pfjets_type_branch = tree->GetBranch(tree->GetAlias("pfjets_type"));
    if (pfjets_type_branch) { pfjets_type_branch->SetAddress(&pfjets_type_); }
  }
...
void CMS3::LoadAllBranches() {
  ...
  if (pfjets_matched_branch != 0) pfjets_matched();
  ...
  if (pfjets_type_branch != 0) pfjets_type();
...
const vector<bool> &CMS3::pfjets_matched() {
  if (not pfjets_matched_isLoaded) {
    if (pfjets_matched_branch != 0) {
      pfjets_matched_branch->GetEntry(index);
    } else {
      printf("branch pfjets_matched_branch does not exist!\n");
      exit(1);
    }
    pfjets_matched_isLoaded = true;
  }
  return pfjets_matched_;
}
...
const vector<int> &CMS3::pfjets_type() {
  if (not pfjets_type_isLoaded) {
    if (pfjets_type_branch != 0) {
      pfjets_type_branch->GetEntry(index);
    } else {
      printf("branch pfjets_type_branch does not exist!\n");
      exit(1);
    }
    pfjets_type_isLoaded = true;
  }
  return pfjets_type_;
}
...
namespace tas {
  ...
  const vector<bool> &pfjets_matched() { return cms3.pfjets_matched(); }
  ...
  const vector<int> &pfjets_type() { return cms3.pfjets_type(); }
